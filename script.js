...
const input = document.querySelectorAll('#SHAREC')


input.addEventListener('#SHAREC', e => {
  const value = e.target.value;

  input.value = `${value}%`
})

const inputs = document.querySelectorAll('#SHAREC')
...
function Calculadora(){
        ...
        var dif4_ = dif4.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
            ...
            document.getElementById("txcredito").value == "") {
                ...
                document.getElementById("bloco7-mp").style.background = "#ce2626"
            } else {
                    document.getElementById("bloco7-mp").style.background = "#04aa6d"
